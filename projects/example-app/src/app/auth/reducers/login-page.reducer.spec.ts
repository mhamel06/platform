...
describe('LoginPageReducer', () => {
  ...
  describe('LOGIN', () => {
    it('should make pending to true', () => {
      ...
      const createAction = LoginPageActions.Actions.login({
        credentials: user,
      });
  ...
  describe('LOGIN_SUCCESS', () => {
    it('should have no error and no pending state', () => {
      ...
      const createAction = AuthApiActions.Actions.loginSuccess({ user });
  ...
  describe('LOGIN_FAILURE', () => {
    it('should have an error and no pending state', () => {
      ...
      const createAction = AuthApiActions.Actions.loginFailure({ error });
